...
The data/controller logic stays in mod_under_pressure_mastery.  This module replaces
its Scaleform injection path at runtime with a Wulf/GameFace view.  No SWF is loaded.
...
def close_view():
    ...
    try:
        ...
        _logger.exception('Mastery GameFace close failed')
    ...
    try:
        ...
        if _dragActivated:
            ...
            x = int(max(BOUNDARY_GAP,
                        min(sw - PANEL_WIDTH - BOUNDARY_GAP, _dragWindowStart[0] + dx)))
